...
;frame f0
(define f0 (make-frame (make-vect -0.5 -0.5) (make-vect 1 0.0) (make-vect 0.0 1))) ; 这个语句必须放在make-vecct定义之后，因为scheme是解释性语言，并且这个语言会被直接evaluate，如果放在make-vect定义之前，就会报错说make-vect无定义
