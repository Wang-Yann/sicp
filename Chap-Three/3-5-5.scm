(load "3-5-3.scm")
(define random-init 167)
(define (rand-update x) (remainder (+ (* random-init  x) 12345) 183647))
...
(define PI1 (stream-map (lambda (p) (sqrt (/ 6 p))) (monte-carlo cesaro-stream  0 0)))
;;(display-stream (stream-section PI1 10 20))
